...
def parse_config():
    ...
    parser.add_argument('--local_rank', type=int, default=os.environ['LOCAL_RANK'], help='local rank for distributed training')
    parser.add_argument('--local-rank', type=int, default=os.environ['LOCAL_RANK'], help='local rank for distributed training')
